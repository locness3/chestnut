...
CornerPinEffect::CornerPinEffect(ClipPtr c, const EffectMeta *em) : Effect(c, em) {
    ...
    EffectRowPtr bottom_left = add_row("Bottom Left");
    ...
    EffectRowPtr bottom_right = add_row("Bottom Right");
