...
void AudioMonitor::paintEvent(QPaintEvent *) {
    if (global::sequence != nullptr) {
        ...
        int channel_count = av_get_channel_layout_nb_channels(global::sequence->audioLayout());
        ...
        for (i=0;i<channel_count;i++) {
			...
			if (sample_cache_offset != -1 && sample_cache.size() > 0) {
				playhead_offset = (global::sequence->playhead_ - sample_cache_offset) * channel_count;
